...
model_rebounds = joblib.load("model_rebounds.joblib")
model_assists = joblib.load("model_assists.joblib")
...
# Example usage of the function (replace with actual values as needed)
example_player_name = "Trae Young"
prediction = predict_player_performance_auto(example_player_name, "ATL", "HOU", "Away")
print(prediction)
