...
def combine_props_pred_files(odds_file, pred_file, combined_file):
    ...
    merged_data = merged_data[['Player', 'TEAM_ABBREVIATION', 'PTS_np', 'pred_type', 'player_points_over_book', 'player_points_over_line', 'player_points_over', 'player_points_under_book', 'player_points_under_line', 'player_points_under', 'PROPS_DATE', 'LAST_GAME']]
